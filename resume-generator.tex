...
\programminglanguage{{ Telugu (C2 - Native Language) / 6}, { German (A2 - Elementary Level) / 2.5 }, { English (C1 - Professional Work Ability) / 5}}
% Projects text
%\vspace{15mm}
%\languages{
...
\justifying 
I am an experienced software engineer with a proven track record of designing, and implementing an ML infrastructure platform to streamline and optimize end-to-end machine learning pipelines. 
